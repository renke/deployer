...
// src/actions/notifyDeploy.ts
var notifyDeploy_exports = {};
__export(notifyDeploy_exports, {
  run: () => run
});
module.exports = __toCommonJS(notifyDeploy_exports);
...
var run = async () => {
  ...
  core.info(`Notify deploy with outcome "${outcome}"`);
};
run();
